...
<html>
    ...
    <body>
        <%
            ...
            String b=request.getParameter("rpass");
     try
     {
...
out.write("alert('receptionist Is Alredy Registered')");
...
out.write("</script>\n");
     ...
     try
     {
      Class.forName("org.apache.derby.jdbc.ClientDriver");
      Connection con=DriverManager.getConnection("jdbc:derby://localhost:1527/Mca","mca","Ankit@123");
      PreparedStatement ps=con.prepareStatement("insert into receip values(?,?)");
