       ...
       <label for="check">
           ...
           <b>
                <%
                    ...
                    ResultSet rs=st.executeQuery("select * from reg where email='"+session.getAttribute("uname")+"' ");
                    while( rs.next())
                    {
               if(session.getAttribute("uname")!=null)
               {
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <section class="containercart content-section">
            ...
            <h2 class="section-header">CART</h2>
             ...
             <div class="back">
                 <a  href="home.jsp"  ><button class="btn btn-cart " type="button">BACK </button></a>
       ...
       " <div class='cart-quantity cart-column'>"+
           " <input class='cart-quantity-input' type='number' value="+rs1.getInt(5)+"><form action='h.jsp'></form>"+
       ...
       out.print(    
         ...
         "   <div class='cart-total'>"+
           ...
           " </div>"+
               ...
               " <a href='order.jsp' ><b class='btn  btn-purchase'>PURCHASE</b></a></center>"
             );
            ...
            <div class="row d-flex justify-content-between align-items-center">
              ...
              <div class="col-md-2 col-lg-2 col-xl-2">
                <img
                  ...
                  %> "
                  class="img-fluid rounded-3" alt="item_image">
              </div>
              <div class="col-md-3 col-lg-3 col-xl-3">
                  <p class="lead fw-normal mb-2"><% out.print(rs1.getString(1));%></p>
              ...
              <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                <button class="btn btn-link px-2"
                  ...
                  <input id="form1" min="0" name="quantity" value="<% out.print(rs1.getInt(5)); %>" type="number"
              ...
              <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                <h5 class="mb-0"><% out.print(rs1.getString(2));%></h5>
              </div>
              <div class="col-md-1 col-lg-1 col-xl-1 text-end">
               ...
               request.setAttribute("c",c);
                     ...
                     %>
                     <a href='delcart.jsp'  class="text-danger" value=""> <i class="fas fa-trash fa-lg"></i></a>
              </div>
